      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Image 
              src="/attached_assets/generated_images/Italian_athletic_man_floor_gym_exercises_57d662be.webp"
            ...
            />
            <Image 
              src="/attached_assets/generated_images/Italian_man_drinking_protein_shake_fitness_5a15c126.webp"
